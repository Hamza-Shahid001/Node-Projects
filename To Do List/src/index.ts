...
let toDoList:any = [] // Array of To-Do List where data will be stored
let conditions = true // condition to execute To-Do List

let main = async () => {                        // function from where all the system will run
...
let addTask = async () => {                             // Function to add any new task
...
let viewTask = () => {                                  // Function to execute view to do list task
    console.log("\n Your To-Do List");
...
let deleteTask = async () =>{                           // Function to execute delete task operation
    await viewTask()
...
let updateTask = async ()=>{                            // Function to execute update task operation
